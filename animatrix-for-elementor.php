        ...
        $element->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'animatrix-glass-pop' => __( 'Glass Pop (Animatrix)', 'animatrix-for-elementor' ),
                    'eca-explode-in' => __( 'Explode In', 'animatrix-for-elementor' ),
                    'animatrix-explode-in' => __( 'Explode In (Animatrix)', 'animatrix-for-elementor' ),
                    'eca-tilt-zoom' => __( 'Tilt Zoom', 'animatrix-for-elementor' ),
                    'animatrix-tilt-zoom' => __( 'Tilt Zoom (Animatrix)', 'animatrix-for-elementor' ),
                    'eca-float-wave' => __( 'Float Wave', 'animatrix-for-elementor' ),
                    'animatrix-float-wave' => __( 'Float Wave (Animatrix)', 'animatrix-for-elementor' ),
        ...
        $element->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'animatrix-hover-tilt' => __( 'Tilt (Animatrix)', 'animatrix-for-elementor' ),
        ...
        $element->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'animatrix-scroll-glass-pop' => __( 'Glass Pop (Animatrix)', 'animatrix-for-elementor' ),
                    'eca-scroll-explode-in' => __( 'Explode In', 'animatrix-for-elementor' ),
                    'animatrix-scroll-explode-in' => __( 'Explode In (Animatrix)', 'animatrix-for-elementor' ),
                    'eca-scroll-tilt-zoom' => __( 'Tilt Zoom', 'animatrix-for-elementor' ),
                    'animatrix-scroll-tilt-zoom' => __( 'Tilt Zoom (Animatrix)', 'animatrix-for-elementor' ),
                    'eca-scroll-float-wave' => __( 'Float Wave', 'animatrix-for-elementor' ),
                    'animatrix-scroll-float-wave' => __( 'Float Wave (Animatrix)', 'animatrix-for-elementor' ),
                    'eca-scroll-matrix-shift' => __( 'Matrix Shift', 'animatrix-for-elementor' ),
                    'animatrix-scroll-matrix-shift' => __( 'Matrix Shift (Animatrix)', 'animatrix-for-elementor' ),
                ],
            ]
        );
